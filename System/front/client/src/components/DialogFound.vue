      ...
      <div class="form">
        ...
        >
          <el-form-item label="订单类型:">
            <el-select v-model="form.type" placeholder="订单类型">
              <el-option
